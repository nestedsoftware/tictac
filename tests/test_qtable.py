...
def test_get_q_values_initial():
    ...
    assert np.array_equal(q_values, np.full(4, 0.5))
...
def test_get_noisy_q_values_initial_no_noise():
    ...
    assert np.array_equal(noisy_q_values, np.full(4, 0.5))
...
def test_get_noisy_q_values_initial_full_noise():
    ...
    expected_q_values = np.array(
        [2.26405235, 0.90015721, 1.47873798, 2.7408932])
...
def test_get_noisy_q_values_initial_1_10th_noise():
    ...
    expected_q_values = np.array(
        [0.6764052, 0.5400157, 0.5978738, 0.7240893])
...
#     train_episode(board, 0.9, 0.9, 0.0, q_table)
...
#     train_episode(board1, 1.0, 1.0, 0.0, q_table)
